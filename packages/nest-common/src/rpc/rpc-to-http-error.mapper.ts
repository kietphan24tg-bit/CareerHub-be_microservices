...
const HTTP_EXCEPTION_BY_RPC_CODE: Record<string, HttpExceptionCtor> = {
    ...
    INTERVIEW_STATE_INVALID: BadRequestException,
    ...
    OFFER_ACCEPT_STATE_INVALID: BadRequestException,
    OFFER_ALREADY_EXISTS: ConflictException,
    OFFER_APPLICATION_STATE_INVALID: BadRequestException,
    OFFER_DECLINE_STATE_INVALID: BadRequestException,
    OFFER_EXPIRATION_REQUIRED: BadRequestException,
    OFFER_NOT_FOUND: NotFoundException,
    OFFER_SEND_STATE_INVALID: BadRequestException,
    OFFER_STATE_INVALID: BadRequestException,
