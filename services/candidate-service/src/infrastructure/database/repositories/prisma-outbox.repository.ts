...
import type {
  CandidateOutboxBacklogSummary,
  CandidateOutboxRepository
} from '../../../application';
...
export class PrismaCandidateOutboxRepository implements CandidateOutboxRepository {
  ...
  async summarizeBacklog(): Promise<CandidateOutboxBacklogSummary> {
